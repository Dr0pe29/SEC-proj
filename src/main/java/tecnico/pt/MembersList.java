...
public class MembersList {
    ...
    private static final String KEY0 = "";

    public final Map<Integer, MemberInfo> MEMBERS = Map.of(
        0, new MemberInfo("127.0.0.1", 12349, Base64.getDecoder().decode(KEY0)),
